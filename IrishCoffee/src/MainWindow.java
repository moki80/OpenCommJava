...
public class MainWindow extends PApplet {
	...
	public void setup() {
		...
		people.add(new Person(p, 1, "naj.png","Najla E.").setInitialXY(67, 108));
		people.add(new Person(p, 2, "nora.png","Nora N.").setInitialXY(133, 54));
		people.add(new Person(p, 3,"risa.png", "Risa N.").setInitialXY(200, 210));
		people.add(new Person(p, 4,"mak.png","Makoto B.").setInitialXY(267, 162)); 
